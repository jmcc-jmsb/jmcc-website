...
| Happening Marketing discipline list | `src/data/competitions.json` → `regionals` → `happening-marketing.disciplines` | Pending — the only competition with an empty list; its card links to the unfiltered page |
